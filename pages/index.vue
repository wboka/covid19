<template>
  <div>
    ...
    <Stats
      :deaths="stats.death"
      :hospitalized="stats.hospitalizedCumulative"
    ...
    <div v-show="showDailyStats">
      ...
      <div v-for="stat in dailyStats" :key="stat.date">
        ...
        <Stats
          :deaths="stat.death"
          :hospitalized="stat.hospitalizedCurrently"
...
export default {
  ...
  async asyncData({ params }) {
    ...
    const { data: stats } = await axios.get(
      'https://covidtracking.com/api/us.json'
    )
    const { data: dailyStats } = await axios.get(
      'https://covidtracking.com/api/us/daily.json'
    )
